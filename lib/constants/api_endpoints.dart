...
class ApiEndpoints {
  ...
  static String guestCart(String cartId) =>
      '/rest/default/V1/guest-carts/$cartId';
  static String guestCartItems(String cartId) =>
      '/rest/default/V1/guest-carts/$cartId/items';
  static String guestCartItem(String cartId, int itemId) =>
      '/rest/default/V1/guest-carts/$cartId/items/$itemId';
  static String guestCartEstimateShipping(String cartId) =>
      '/rest/default/V1/guest-carts/$cartId/estimate-shipping-methods';
  static String guestCartShippingInformation(String cartId) =>
      '/rest/default/V1/guest-carts/$cartId/shipping-information';
  static String guestCartPaymentMethods(String cartId) =>
      '/rest/default/V1/guest-carts/$cartId/payment-methods';
  static String guestCartPaymentInformation(String cartId) =>
  ...
  static String cartItems(String cartId) =>
      '/rest/default/V1/carts/$cartId/items';
  static String cartItem(String cartId, int itemId) =>
      '/rest/default/V1/carts/$cartId/items/$itemId';
